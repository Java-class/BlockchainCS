...
public class Commons {
    ...
    private static PeerSetting peerSetting;

    public static PeerSetting getPeerSetting() {
        return peerSetting;
    }
    public static void setPeerSetting(PeerSetting setting) {
        Commons.peerSetting = setting;
    }
